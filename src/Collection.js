...
function filterCollectionName(e) {
    ...
    for (let r = 0; r < e.length; r++) {
        let i = e.charAt(r);
        "abcdefghijklmnoprstuvyzwxqABCDEFGHIJKLMNOPRSTUVYZWXQ1234567890_".includes(i) && (t += i)
    }
    ...
    constructor(e) {
        ...
        return e.save_timeout && e.save_timeout < 1 ? Debugger.error("Valid option value: CollectionOptions.Save_Timeout >= 1") : e.save_timeout && e.save_timeout > 25 ? Debugger.error("Valid option value: CollectionOptions.Save_Timeout <= 25") : e.save_directly_after && e.save_directly_after < 1 ? Debugger.error("Valid option value: CollectionOptions.Save_Directly_After >= 1") : e.save_directly_after && e.save_directly_after > 500 ? Debugger.error("Valid option value: CollectionOptions.Save_Directly_After <= 500") : e.cache_retention_time && e.cache_retention_time < -1 ? Debugger.error("Valid option value: CollectionOptions.Cache_Retention_Time >= -1") : e.cache_retention_time && e.cache_retention_time > 20160 ? Debugger.error("Valid option value: CollectionOptions.Cache_Retention_Time <= 20160") : e.backup_retention_time && e.backup_retention_time < -1 ? Debugger.error("Valid option value: CollectionOptions.Backup_Retention_Time >= -1") : e.backup_retention_time && e.backup_retention_time > 365 ? Debugger.error("Valid option value: CollectionOptions.Backup_Retention_Time <= 365") : (e.name = filterCollectionName(e.name), Debugger.log("Starting collection '\x1b[35m" + e.name + "\x1b[32m'..."), fs.mkdirSync(path.join("./", "./peakdb/Collections"), {
            ...
            .all()[0] && !0 === Array.isArray(bson.deserialize(this._db.prepare("SELECT * FROM peakdb")
                ...
                .run(bson.serialize({
                    data: {}
                })), this._DataHandler = new DataManager(this._db, e), Debugger.log("Collection '\x1b[35m" + e.name + "\x1b[32m' has been started."), !0 === e.caching && Debugger.log("\x1b[31mWARNING! \x1b[32mCaching is active, data are kept in cache. For these large collections, it means more RAM loss."), "DOCUMENT_BASED" === e.type ? (this.insert = (t => CollectionManager.document_based.insert(this._DataHandler, e, t)), this.find = ((t, r) => CollectionManager.document_based.find(this._DataHandler, e, t, r)), this.filter = ((t, r) => CollectionManager.document_based.filter(this._DataHandler, e, t, r)), this.has = ((t, r) => CollectionManager.document_based.has(this._DataHandler, e, t, r)), this.update = ((t, r) => CollectionManager.document_based.update(this._DataHandler, e, t, r)), this.archive = (t => CollectionManager.document_based.archive(this._DataHandler, e, t)), this.unarchive = (t => CollectionManager.document_based.unarchive(this._DataHandler, e, t)), this.delete = (t => CollectionManager.document_based.delete(this._DataHandler, e, t))) : "KEY_VALUE_BASED" === e.type && (this.set = ((t, r) => CollectionManager.key_value_based.set(this._DataHandler, e, t, r)), this.get = (t => CollectionManager.key_value_based.get(this._DataHandler, e, t)), this.push = ((t, r) => CollectionManager.key_value_based.push(this._DataHandler, e, t, r)), this.remove = ((t, r) => CollectionManager.key_value_based.remove(this._DataHandler, e, t, r)), this.find = ((t, r) => CollectionManager.key_value_based.find(this._DataHandler, e, t, r)), this.filter = ((t, r) => CollectionManager.key_value_based.filter(this._DataHandler, e, t, r)), this.has = ((t, r) => CollectionManager.key_value_based.has(this._DataHandler, e, t, r)), this.increase = ((t, r) => CollectionManager.key_value_based.increase(this._DataHandler, e, t, r)), this.reduce = ((t, r) => CollectionManager.key_value_based.reduce(this._DataHandler, e, t, r)), this.delete = (t => CollectionManager.key_value_based.delete(this._DataHandler, e, t))), this.backup = (() => CollectionManager.public.backup(this._db, e)), !0 === e.activate_destroy_function && (this.destroy = (() => CollectionManager.public.destroy(this._DataHandler, e))), void(!0 === e.auto_backup && setInterval(() => {
