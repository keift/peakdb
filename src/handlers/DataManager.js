    ...
    constructor(e, t) {
        this._set_count = 0, this._cache_timeout_function = (() => {
            clearTimeout(this._cache_timeout), this._cache_timeout = setTimeout(() => {
                ...
                .all()[0].data)
            .data, t.cache_retention_time && t.cache_retention_time > -1 && this._cache_timeout_function()), this.get = (() => (!0 === t.caching && this._cache && t.cache_retention_time && t.cache_retention_time > -1 && this._cache_timeout_function(), !0 !== t.caching || this._cache || (this._cache = bson.deserialize(e.prepare("SELECT * FROM peakdb")
                    .all()[0].data)
